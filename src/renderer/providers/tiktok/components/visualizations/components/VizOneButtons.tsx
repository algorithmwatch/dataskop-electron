    ...
    <Switcher.Group>
      <div className={clsx("flex items-center justify-start", className)}>
        <Switcher
          ...
          disabled={disabled}
          onChange={onChange}
          className="group relative inline-flex h-5 w-10 shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
          <span
            aria-hidden="true"
          ...
          <span
            aria-hidden="true"
            className={clsx(
              { "bg-lavender-200": checked && !disabled },
              { "bg-gray-300": checked && disabled },
              { "bg-lavender-300": !checked },
          ...
          <span
            ...
            className={clsx(
              ...
              checked ? "translate-x-5 " : "translate-x-0 bg-indigo-800",
