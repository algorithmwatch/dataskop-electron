...
import { onlySubmitConsentForm } from 'renderer/providers/youtube/actions/confirm-cookies';
import { createSingleGenerator } from 'renderer/providers/youtube/procedures/setup';
